icecream_db = [
    ...
    },
    {
        ...
        'description': ('Сырьё: сливки, паста, фрукты и ягоды в свежем виде, '
    ...
    {
    'name': 'Мороженное по Аджарски',
    'description': ('Сырное мороженное в форме лодочки, в центре разбитое яйцо.'
                    'Употреблять горячим — '
                    'можно танцевать <strong>Лесгинку</strong>.'),
    },
]
